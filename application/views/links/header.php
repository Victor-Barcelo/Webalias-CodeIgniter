      ...
      <div class="jumbotron">
         <div class="container">
          ...
          <ul class="nav nav-pills nav-justified">
            <li id ="header-but-search" role="presentation" class=""><a href="<?=$main_url?>">Consulta un alias</a></li>
            <li id="header-but-create" role="presentation" class=""><a href="<?=$create_url?>">Crea tu alias</a></li>
          </ul>
